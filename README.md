# Tigron AutoAdv (MVP Backend Scaffold)

This repository contains a minimal, framework-agnostic backend core for **Tigron AutoAdv**:
...
- `src/tigron_autoadv/models.py` — dataclasses and enums
- `src/tigron_autoadv/service.py` — ad management and plan-limit checks
- `src/tigron_autoadv/scheduler.py` — scheduler tick, retries, duplicate-send protection
